...
if __name__ == "__main__":
    ...
    NO_EOD = "--no-eod" in sys.argv  # <--- New Flag
    ...
    if NO_EOD:
        feed.automate_eod = False
        print("NOTICE: EOD Batch Automation is DISABLED (--no-eod).")
    else:
        print("It will run EOD Batch automatically at 16:00.")
